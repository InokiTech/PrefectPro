        ...
        <tbody>
            <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    ...
                    <td class="link"> <a href="<?php echo e(asset('assets/uploads/offline_payment/'.$invoice['document_image'])); ?>" download> <?php echo e($invoice['document_image']); ?> </a></td>
                    <td>
                    ...
                    <td>
                        <div class="adminTable-action">
                            ...
                            >
                              ...
                              <li>
                                <a class="dropdown-item" href="javascript:;" onclick="confirmModal('<?php echo e(route('accountant.update_offline_payment', ['id' => $invoice->id,'status'=>'approve'])); ?>', 'undefined');"><?php echo e(get_phrase('Approve')); ?></a>
                              </li>
                              <li>
                                <a class="dropdown-item" href="javascript:;" onclick="confirmModal('<?php echo e(route('accountant.update_offline_payment', ['id' => $invoice->id,'status'=>'decline'])); ?>', 'undefined');"><?php echo e(get_phrase('Decline')); ?></a>
                              </li>
                            </ul>
                        </div>
                    </td>
            ...
            <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <small><?php echo e($student_details['section_name']); ?>
...
<?php /**PATH /home/swiftypo/public_html/resources/views/accountant/student_fee_manager/list_pending.blade.php ENDPATH**/ ?>