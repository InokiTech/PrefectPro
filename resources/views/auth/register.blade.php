...
<div class="register-section container shadow" id="myModal">
    ...
    <!-- Modal body -->
    <div class="row popup">
        <form method="POST" enctype="multipart/form-data" class="modal-body ajaxForm" action="{{ route('school.create') }}">
            @csrf
            <div class="register-left">
                <h6>{{ get_phrase('SCHOOL INFO') }}</h6>
                <label for="school_domain" class="form-label">{{ get_phrase('School Domain') }}</label>
            ...
            <div class="register-right">
                ...
                <div class="mb-1 mt-2">
                    <label for="birthday" class="form-label">{{ get_phrase('Date of Birth') }}</label>
