	...
	<div class="form-row">
        ...
        <div class="fpb-7">
			...
			<select name="payment_method" id="payment_method" class="form-select eForm-select eChoice-multiple-with-remove">
                ...
                <option value="paystack" <?php if ($invoice_details['payment_method'] == 'paystack'): ?> selected <?php endif; ?>><?php echo e(get_phrase('Paystack')); ?></option>
			</select>
		</div>
...
</script><?php /**PATH /home/foxtjfzg/public_html/academits.com/resources/views/admin/student_fee_manager/edit.blade.php ENDPATH**/ ?>