...
<div class="row">
    <div class="col-12">
        <div class="eSection-wrap">
            <div class="title">
                <h3>
                    <?php echo e(get_phrase('Paystack settings')); ?>
                    ...
                    <div class="col-md-6 pb-3">
                        <div class="eForm-layouts">
                            <form method="POST" class="col-12 live-class-settings-form"
                                action="<?php echo e(route('superadmin.update_payment_settings')); ?>"
                                id="live-class-settings-form">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="fpb-7">
                                    ...
                                    <select class="form-select eForm-select eChoice-multiple-with-remove"
                                        name="status">
                                        <option value="1" <?php echo e($paystack['status'] == 1 ? 'selected' : ''); ?>>
                                            <?php echo e(get_phrase('Yes')); ?></option>
                                        <option value="0" <?php echo e($paystack['status'] == 0 ? 'selected' : ''); ?>>
                                ...
                                <div class="fpb-7">
                                    ...
                                    <select class="form-select eForm-select eChoice-multiple-with-remove"
                                        name="mode">
                                        <option value="live" <?php echo e($paystack['mode'] == 'live' ? 'selected' : ''); ?>>
                                            <?php echo e(get_phrase('Live')); ?></option>
                                        <option value="test" <?php echo e($paystack['mode'] == 'test' ? 'selected' : ''); ?>>
                                            <?php echo e(get_phrase('Test')); ?></option>
                                    </select>
                                </div>

                                <div class="fpb-7">
                                    <label for="test_key"
                                        class="eForm-label"><?php echo e(get_phrase('Test Public Key')); ?></label>
                                    <input type="text" class="form-control eForm-control" id="test_key"
                                        name="test_key" placeholder="Test Public Key"
                                        value="<?php echo e($paystack['test_key']); ?>" aria-label="Test Public Key" required>
                                </div>


                                <div class="fpb-7">
                                    <label for="test_secret_key"
                                        class="eForm-label"><?php echo e(get_phrase('Test Sectect Key')); ?></label>
                                    <input type="text" class="form-control eForm-control" id="test_secret_key"
                                        name="test_secret_key" placeholder="Test Sectect Key"
                                        value="<?php echo e($paystack['test_secret_key']); ?>" aria-label="Test Sectect Key"
                                        required>
                                </div>

                                <div class="fpb-7">
                                    <label for="public_live_key"
                                        class="eForm-label"><?php echo e(get_phrase('Live Public Key')); ?></label>
                                    <input type="text" class="form-control eForm-control" id="public_live_key"
                                        name="public_live_key" placeholder="Live Public Key"
                                        value="<?php echo e($paystack['public_live_key']); ?>" aria-label="Live Public Key"
                                        required>
                                </div>
                                ...
                                <div class="fpb-7">
                                    <label for="secret_live_key"
                                        class="eForm-label"><?php echo e(get_phrase('Live Secrect Key')); ?></label>
                                    <input type="text" class="form-control eForm-control" id="secret_live_key"
                                        name="secret_live_key" placeholder="Live Secrect Key"
                                        value="<?php echo e($paystack['secret_live_key']); ?>" aria-label="Live Secrect Key"
                                        required>
                                </div>
                                ...
                                <div class="fpb-7 pt-2">
                                    <button type="submit" class="btn-form"
                                        onclick=""><?php echo e(get_phrase('Update Paystack ')); ?></button>
                                </div>
                                <!-- superadmin.update_payent_settings -->
                            </form>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('superadmin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/foxtjfzg/public_html/academits.com/resources/views/superadmin/payment_credentials/payment_settings.blade.php ENDPATH**/ ?>