...
<form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('librarian.book_issue.update', ['id' => $book_issue_details->id])); ?>">
    <?php echo csrf_field(); ?> 
    <div class="form-row">
		<div class="fpb-7">
...
</script><?php /**PATH /home/swiftypo/public_html/resources/views/librarian/book_issue/edit.blade.php ENDPATH**/ ?>