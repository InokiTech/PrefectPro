...
use App\Http\Controllers\SchoolPaystackController;
...
//Added Manual Paystack Method
Route::controller(PaystackController::class)->middleware('auth', 'admin')->group(function() {
    Route::post('admin/subscription/paystack/{package_id}', 'initializePaystack')->name('admin.subscription.paystack.pay');
    Route::get('admin/subscription/paystack/callback', 'authorizePaystack')->name('admin.subscription.paystack.authorize');
});
//Manual Paystack Method end here
...
//Added Manual Paystack Method
Route::controller(SchoolPaystackController::class)->middleware('student','auth')->group(function() {

    Route::post('student/school_fee/paystack/{id}', 'initializePaystack')->name('student.paystack.pay');
    Route::get('student/paystack/callback', 'authorizePaystack')->name('student.paystack.authorize');
});
//Manual Paystack Method end here
