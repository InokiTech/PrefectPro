...
<head>
    <!-- New -->
    <title><?php echo e(get_phrase('Admin').' | '.tenant('id') ? tenant('id') : 'Prefect Pro'); ?></title>
    <!-- all the meta tags -->
    <meta charset="utf-8" />
                  ...
                  <li class="user-profile">
                    <div class="btn-group">
                      ...
                      >
                        ...
                        <!-- Logout Button -->
                        <li>
                            <a class="btn eLogut_btn" href="<?php echo e(tenant('id') ? route('tenant.logout') : route('logout')); ?>" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                <span>
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="14.046"
                            ...
                            <form id="logout-form" action="<?php echo e(tenant('id') ? route('tenant.logout') : route('logout')); ?>" method="POST" class="d-none">
                                <?php echo csrf_field(); ?>
                            </form>
                        </li>
                      </ul>
...
<?php /**PATH C:\laragon\www\PrefectPro\resources\views/admin/navigation.blade.php ENDPATH**/ ?>