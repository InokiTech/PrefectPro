      ...
      <li class="nav-links-li <?php echo e(request()->is('librarian/dashboard') ? 'showMenu':''); ?>">
        <div class="iocn-link">
          <a href="<?php echo e(route('librarian.dashboard')); ?>">
			...
			<!-- Sidebar menu -->
			<li class="nav-links-li <?php echo e(request()->is('librarian/book*') || request()->is('librarian/book_issue*') || request()->is('librarian/noticeboard*') || request()->is('librarian/events/list*') ? 'showMenu':''); ?>">
          <div class="iocn-link">
              <a href="#">
                  <div class="sidebar_icon">
          ...
          <ul class="sub-menu">
              <li>
                <a class="<?php echo e((request()->is('librarian/book/list')) ? 'active' : ''); ?>" href="<?php echo e(route('librarian.book.book_list')); ?>">
                  <span><?php echo e(get_phrase('Book List Manager')); ?></span>
                </a>
              </li>

              <li>
                <a class="<?php echo e((request()->is('librarian/book_issue')) ? 'active' : ''); ?>" href="<?php echo e(route('librarian.book_issue.list')); ?>">
                  <span><?php echo e(get_phrase('Book Issue Report')); ?></span>
                </a>
              </li>

              <li>
                <a class="<?php echo e((request()->is('librarian/noticeboard*')) ? 'active' : ''); ?>" href="<?php echo e(route('librarian.noticeboard.list')); ?>">
                  <span><?php echo e(get_phrase('Noticeboard')); ?></span>
                </a>
              </li>

              <li>
                  <a class="<?php echo e((request()->is('librarian/events/list*')) ? 'active' : ''); ?>" href="<?php echo e(route('librarian.events.list')); ?>">
                  ...
                  <li class="user-profile">
                    <div class="btn-group">
                      ...
                      >
                        ...
                        <li>
                          <a class="dropdown-item" href="<?php echo e(route('librarian.password', ['edit'])); ?>">
                            <span>
...
<?php /**PATH /home/swiftypo/public_html/resources/views/librarian/navigation.blade.php ENDPATH**/ ?>