                        ...
                        <div class="eForm-layouts">
                            <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('admin.school.update')); ?>">
                                ...
                                <div class="fpb-7">
                                    ...
                                    <input type="text" class="form-control eForm-control" value="<?php echo e($school_details->phone); ?>" id="phone" name = "phone" required>
                                </div>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\PrefectPro\resources\views/admin/settings/school_settings.blade.php ENDPATH**/ ?>