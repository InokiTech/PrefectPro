                                    ...
                                    <div class="dashboard_ShortListItem">
                                        ...
                                        <div class="dsBody d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="ds_item_icon">
                                                <img src="<?php echo e(asset('assets/images/Student_icon.png')); ?>" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="dashboard_ShortListItem">
                                        ...
                                        <div class="dsBody d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="ds_item_icon">
                                                <img src="<?php echo e(asset('assets/images/Teacher_icon.png')); ?>" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="dashboard_ShortListItem">
                                        ...
                                        <div class="dsBody d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="ds_item_icon">
                                                <img src="<?php echo e(asset('assets/images/Parents_icon.png')); ?>" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="dashboard_ShortListItem">
                                        ...
                                        <div class="dsBody d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="ds_item_icon">
                                                <img src="<?php echo e(asset('assets/images/Staff_icon.png')); ?>" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="ds_report_left">
                                    ...
                                    <div class="ds_report_count d-flex align-items-center">
                                        ...
                                        <div class="ds_attend_percent">
                                            <div class="icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16.507" height="10.25" viewBox="0 0 16.507 10.25">
                                                    <g id="Group_2395" data-name="Group 2395" transform="translate(-343.381 -436.505)">
                                                        ...
                                                        <g id="Polygon_2" data-name="Polygon 2" transform="matrix(0.643, 0.766, -0.766, 0.643, 356.596, 436.505)" fill="#fff">
                                                            <path d="M 4.187728404998779 3.341484308242798 L 0.9342562556266785 3.341484308242798 L 2.560992240905762 0.9013835787773132 L 4.187728404998779 3.341484308242798 Z" stroke="none" />
                                                            <path d="M 2.560992240905762 1.802777767181396 L 1.868520259857178 2.841484546661377 L 3.253464221954346 2.841484546661377 L 2.560992240905762 1.802777767181396 M 2.560992240905762 4.529953002929688e-06 L 5.121982097625732 3.841484308242798 L 2.384185791015625e-06 3.841484308242798 L 2.560992240905762 4.529953002929688e-06 Z" stroke="none" fill="#fff" />
                                                        </g>
                                                    </g>
                                                </svg>
                                            </div>
                            ...
                            <div class="dashboard_report dashboard_income_report">
                                <div class="ds_report_header d-flex justify-content-between align-items-start">
                                    ...
                                    <div class="verticalMenu">
                                        <button type="button" class="eBtn dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="5" height="20.999" viewBox="0 0 5 20.999">
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/foxtjfzg/public_html/academits.com/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>