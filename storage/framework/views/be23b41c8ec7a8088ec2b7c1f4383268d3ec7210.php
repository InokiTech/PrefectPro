                ...
                <tr>
                    ...
                    <td class="text-start">
                        <div class="adminTable-action">
                            ...
                            <?php if (!$book_issue['status']): ?>
                                  <li>
                                    <a class="dropdown-item" href="javascript:;" onclick="rightModal('<?php echo e(route('librarian.edit.book_issue', ['id' => $book_issue->id])); ?>', '<?php echo e(get_phrase('Update book issue information')); ?>')"><?php echo e(get_phrase('Edit')); ?></a>
                                  </li>
                                  <li>
                                    <a class="dropdown-item" href="javascript:;" onclick="confirmModal('<?php echo e(route('librarian.book_issue.return', ['id' => $book_issue->id])); ?>', 'undefined');"><?php echo e(get_phrase('Return this book')); ?></a>
                                  </li>
                            <?php endif; ?>
                              <li>
                                <a class="dropdown-item" href="javascript:;" onclick="confirmModal('<?php echo e(route('librarian.book_issue.delete', ['id' => $book_issue->id])); ?>', 'undefined');"><?php echo e(get_phrase('Delete')); ?></a>
                              </li>
                            </ul>
                        </div>
                    </td>
...
<?php endif; ?><?php /**PATH /home/swiftypo/public_html/resources/views/librarian/book_issue/list.blade.php ENDPATH**/ ?>