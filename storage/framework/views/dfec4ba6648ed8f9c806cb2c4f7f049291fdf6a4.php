            ...
            >
                <div class="d-flex flex-column">
                    ...
                    <ul class="d-flex align-items-center eBreadcrumb-2">
                        ...
                        <li><a href="#"><?php echo e(get_phrase('Book')); ?></a></li>
                    </ul>
                </div>
                <div class="export-btn-area">
                    <a href="javascript:;" class="export_btn" onclick="rightModal('<?php echo e(route('librarian.book.open_modal')); ?>', '<?php echo e(get_phrase('Add book')); ?>')"><i class="bi bi-plus"></i><?php echo e(get_phrase('Add book')); ?></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="eSection-wrap">
        	<div class="search-filter-area d-flex justify-content-md-between justify-content-center align-items-center flex-wrap gr-15">
		        <form action="<?php echo e(route('librarian.book.book_list')); ?>">
			        <div
			                ...
			                <tr>
					            ...
					            <td class="text-start">
					            	<div class="adminTable-action">
			                            ...
			                            >
			                              <li>
			                                <a class="dropdown-item" href="javascript:;" onclick="rightModal('<?php echo e(route('librarian.edit.book', ['id' => $book->id])); ?>', '<?php echo e(get_phrase('Edit Book')); ?>')"><?php echo e(get_phrase('Edit')); ?></a>
			                              </li>
			                              <li>
			                                <a class="dropdown-item" href="javascript:;" onclick="confirmModal('<?php echo e(route('librarian.book.delete', ['id' => $book->id])); ?>', 'undefined');"><?php echo e(get_phrase('Delete')); ?></a>
			                              </li>
			                            </ul>
			                        </div>
					            </td>
...
<?php echo $__env->make('librarian.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/swiftypo/public_html/resources/views/librarian/book/list.blade.php ENDPATH**/ ?>