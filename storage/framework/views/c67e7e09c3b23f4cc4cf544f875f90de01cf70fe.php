<form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('accountant.create.expense_category')); ?>">
  <?php echo csrf_field(); ?> 
  <div class="form-row">
    <div class="fpb-7">
...
<?php /**PATH /home/swiftypo/public_html/resources/views/accountant/expense_category/create.blade.php ENDPATH**/ ?>