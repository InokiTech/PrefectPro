<form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('accountant.create.expenses')); ?>">
    <?php echo csrf_field(); ?> 
    <div class="form-row">
        <div class="fpb-7">
...
</script><?php /**PATH /home/swiftypo/public_html/resources/views/accountant/expenses/create.blade.php ENDPATH**/ ?>