...
<div class="register-section container shadow" id="myModal">
    ...
    <!-- Modal body -->
    <div class="row popup">
        <form method="POST" enctype="multipart/form-data" class="modal-body ajaxForm" action="<?php echo e(route('school.create')); ?>">
            <?php echo csrf_field(); ?>
            <div class="register-left">
                <h6><?php echo e(get_phrase('SCHOOL INFO')); ?></h6>
                <label for="school_domain" class="form-label"><?php echo e(get_phrase('School Domain')); ?></label>
                <div class="input-group mb-1 mt-1">
                    <input type="text" class="form-control" id="school_domain" name="school_domain" required />
                    <span class="input-group-text" id="basic-addon2">.Prefectpro.com</span>
                </div>
                <div class="mb-1 mt-3">
                ...
                <div class="mt-3">
                    ...
                    <textarea class="form-control school-info" style="min-height: 250px; height: 265px; max-height: 350px;" id="school_info" name="school_info" required></textarea>
                </div>
            ...
            <div class="register-right">
                ...
                <div class="mb-1 mt-2">
                    <label for="birthday" class="form-label"><?php echo e(get_phrase('Date of Birth')); ?></label>
                ...
                <div class="mb-1 mt-2">
                    ...
                    <input type="password" id="admin_password" class="form-control mb-3" name="admin_password" required />
                </div>
