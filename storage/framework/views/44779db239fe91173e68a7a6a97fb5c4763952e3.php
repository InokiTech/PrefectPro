                    ...
                    <div class="col-md-6 pb-3">
                        <div class="eForm-layouts">
                            <form method="POST" class="col-12 live-class-settings-form"
                                action="<?php echo e(route('admin.settings.payment_post')); ?>" id="live-class-settings-form">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="fpb-7">
                                    ...
                                    <input type="text" class="form-control eForm-control" id="test_key"
                                        ...
                                        value="<?php echo e($paystack_keys->test_key); ?>" aria-label="Test Public Key"
                                        required>
                                </div>
                                ...
                                <div class="fpb-7">
                                    <label for="test_secret_key"
                                        class="eForm-label"><?php echo e(get_phrase('Test Secrect Key')); ?></label>
                                    <input type="text" class="form-control eForm-control" id="test_secret_key"
                                        name="test_secret_key" placeholder="Test Secrect Key"
                                        value="<?php echo e($paystack_keys->test_secret_key); ?>" aria-label="Test Secrect Key"
                                        required>
                                </div>
                                ...
                                <div class="fpb-7">
                                    ...
                                    <input type="text" class="form-control eForm-control" id="public_live_key"
                                        ...
                                        value="<?php echo e($paystack_keys->public_live_key); ?>"
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/foxtjfzg/public_html/academits.com/resources/views/admin/payment_settings/key_settings.blade.php ENDPATH**/ ?>