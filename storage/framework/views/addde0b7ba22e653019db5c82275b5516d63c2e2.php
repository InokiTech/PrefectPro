<form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('accountant.create.fee_manager', ['value' => 'mass'])); ?>">
	<?php echo csrf_field(); ?> 
	<div class="form-row">
		<div class="fpb-7">
		...
		<div class="fpb-7">
			...
			<select name="payment_method" id="payment_method" class="form-select eForm-select eChoice-multiple-with-remove">
				...
				<option value="paypal"><?php echo e(get_phrase('Online')); ?></option>
			</select>
		</div>
...
</script><?php /**PATH /home/swiftypo/public_html/resources/views/accountant/student_fee_manager/mass.blade.php ENDPATH**/ ?>